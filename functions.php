 ...
 * Plugin URI: https://www.basefold.com/how-to-lazy-load-images-on-wordpress/
 * Description: Lazy load resources likes images with Lazysizes.
 * Version: 1.0
 * Author: basefold
 */
...
function basefold_lazyload_images( $content ) {
    if( empty( $content ) ) {
        return $content;
    }
...
add_filter('the_content', 'basefold_lazyload_images');
?>
